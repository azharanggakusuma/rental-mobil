    ...
    <div class="container table-responsive">
        ...
        <form action="proses.php" method="post">
            ...
            <div class="text-center d-grid gap-2 d-md-flex justify-content-md-center">
                ...
                <button onclick="window.location.href='mobil.php'" class="btn btn-danger" type="button">Batal</button>
            </div>
        </form><br><br><br>
        ...
        <table class="table table-bordered table-hover">
            ...
            <div class="text-center">
                <a href="datapemesanan.php" class="btn btn-success text-center">Data Pemesanan</a>
            </div><br>
        </table><br>
